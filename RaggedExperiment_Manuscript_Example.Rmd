...
https://github.com/LiNk-NY/raggedchk cloned from 
...
```{r}
# https://gdac.broadinstitute.org/runs/analyses__2016_01_28/reports/cancer/COAD-TP/CopyNumberLowPass_Gistic2/nozzle.html
mre <- coad[["COAD_Mutation-20160128"]]
## possible bug -- seqlevelsStyle must go first, then genome
...
|-------------|-------|-----------|-----------------|------------|---------------|-----------------------|-----------------|
| curatedTCGAData | CNASeq | numeric | `r object_size(coad[["COAD_CNASeq-20160128"]])` | `r object_size(as.data.frame(coad[["COAD_CNASeq-20160128"]]@assays))` | `r object_size(sparseAssay(coad[["COAD_CNASeq-20160128"]], sparse = TRUE))` | `r object_size(compactAssay(coad[["COAD_CNASeq-20160128"]]))` | `r object_size(sparseAssay(coad[["COAD_CNASeq-20160128"]]))` |
| curatedTCGAData | CNASeq (in genes) | numeric | `r object_size(ingenes)` | `r object_size(as.data.frame(ingenes@assays))` | `r object_size(sparseAssay(ingenes, sparse = TRUE))` | `r object_size(compactAssay(ingenes))` | `r object_size(sparseAssay(ingenes))` |
| curatedTCGAData | Mutation | character | `r object_size(coad[["COAD_Mutation-20160128"]])` | `r object_size(as.data.frame(coad[["COAD_Mutation-20160128"]]@assays))` | NA | `r object_size(compactAssay(coad[["COAD_Mutation-20160128"]]))` | `r object_size(sparseAssay(coad[["COAD_Mutation-20160128"]]))` |
| curatedTCGAData | Mutation (in genes) | character | `r object_size(mingenes)` | `r object_size(as.data.frame(mingenes@assays))` | NA | `r object_size(compactAssay(mingenes))` | `r object_size(sparseAssay(mingenes))` |
