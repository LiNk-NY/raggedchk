...
https://github.com/LiNk-NY/raggedchk cloned and updated from 
...
|-------------|-------|-----------|-----------------|------------|---------------|-----------------------|-----------------|
| curatedTCGAData | CNASeq | numeric | `r object_size(BRCA[["BRCA_CNASeq-20160128"]])` | `r object_size(as.data.frame(BRCA[["BRCA_CNASeq-20160128"]]@assays))` | `r object_size(sparseAssay(BRCA[["BRCA_CNASeq-20160128"]], sparse = TRUE))` | `r object_size(compactAssay(BRCA[["BRCA_CNASeq-20160128"]]))` | `r object_size(sparseAssay(BRCA[["BRCA_CNASeq-20160128"]]))` |
...
| curatedTCGAData | Mutation | character | `r object_size(BRCA[["BRCA_Mutation-20160128"]])` | `r object_size(as.data.frame(BRCA[["BRCA_Mutation-20160128"]]@assays))` | NA | `r object_size(compactAssay(BRCA[["BRCA_Mutation-20160128"]]))` | `r object_size(sparseAssay(BRCA[["BRCA_Mutation-20160128"]]))` |
